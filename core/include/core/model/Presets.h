...
namespace Presets
{
    ...
    inline TransformerConfig getByIndex(int index)
    {
        switch (index)
        {
            ...
            case 4:  return TransformerConfig::Clean_DI();
            case 5:  return TransformerConfig::Vocal_Warmth();
            case 6:  return TransformerConfig::Bass_Thickener();
            case 7:  return TransformerConfig::Master_Glue();
    ...
    inline const char* getNameByIndex(int index)
    {
        switch (index)
        {
            ...
            case 4:  return "Clean DI";
            case 5:  return "Vocal Warmth";
            case 6:  return "Bass Thickener";
            case 7:  return "Master Glue";
